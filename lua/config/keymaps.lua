...
-- Map <leader>r to copy the relative file path to the clipboard
-- vim.api.nvim_set_keymap("n", "<leader>gr", ':let @+ = expand("%")<CR>', { noremap = true, silent = true })
-- vim.api.nvim_set_keymap("n", "<leader>gy", ':let @+ = expand("%:p")<CR>', { noremap = true, silent = true })
